...
def main():
    ...
    parser.add_argument("--out", default="/home/rohit/Desktop/resolvent_adflow/resolvent_analysis_cylinder", help="Output image file (png)")
    args = parser.parse_args()

    npz_path = "/home/rohit/Desktop/resolvent_adflow/resolvent_analysis_cylinder/output_naca64A010/sweep_omega_0_to_3.npz"
