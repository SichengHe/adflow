...
DEFAULT_SURFACE_PATH = Path(
    r"C:\Users\Rohit\Desktop\article_resolvent_wing\data\resolvent_analysis_airfoil_naca64a010\out_surf.cgns"
)
...
OUTPUT_DIR = Path("figures") / "airfoil_post"
USE_TEX = True  # toggle LaTeX rendering globally
SHOW_DATASET_SUMMARY = True
LIST_FIELDS_ON_LOAD = True
PERFORM_PLOT = True
SHOW_PLOT_WINDOWS = True
FIELD_TO_PLOT = "DeltaVelXSurf"
FIELD_COMPONENT_INDEX: int | None = 0  # None -> magnitude for vector/tensor
...
FIGURE_DPI = 300
PLOT_LEVELS = 50
PLOT_COLORMAP = "inferno"#"RdBu_r"
PLOT_COLORMAP_EXTEND = "both"
FORCE_EQUAL_ASPECT = True
X_LIMITS = (-0.5,1.5)  # e.g., (0.0, 1.0) or None to auto
Y_LIMITS = (-0.5,2)
...
COLORBAR_LABEL_TEMPLATE = r"$\delta \mathbf{{u}}$"
COLORBAR_LIMITS = None  # e.g., (-0.1, 0.1)
COLORBAR_NUM_TICKS = 5
COLORBAR_TICK_FORMAT = "{:.4f}"

CYLINDER_OUTLINE_ENABLED = False
...
TITLE_TEMPLATE = ""
OUTPUT_FILENAME_TEMPLATE = "{field_label_safe}.pdf"
# ---------------------------------------------------------------------------
