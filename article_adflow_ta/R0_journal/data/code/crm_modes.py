...
This case computes resolvent modes for transonic flow over CRM aircraft config:
...
def test_transonic_modes():
    ...
    meshFile = os.path.join(baseDir, "./grids/crm_L1.5.cgns")
    ...
    aeroOptions = {
        ...
        'printTiming': False,
        'printWarnings': True,
        "volumeVariables": ["deltavelx","deltavely","deltavelz","deltarho","deltarhoe"],
    ...
    omega = 0.008  # See the sigma vs omega sweep plot. This is the highest sigma's omega.
    ...
    resolvent.maxSvdIter = 10     # Max SVD iterations (Arnoldi/SVD iterations)
    ...
    resolvent.maxLinearIter = 700         # Max GMRES iterations
    ...
    resolvent.writeModes(petsc_dir, load_into_fortran=False)
    ...
    if rank == 0:
        print("="*80)
        print("TRANSONIC MODE TEST COMPLETE")
        print("="*80)
        print()
...
if __name__ == "__main__":
    ...
    if resolvent is not None and _rank == 0:
        ...
        print("To visualize:")
        print("  cd ../examples")
        print("  python visualize_resolvent_modes.py --cgns-dir ../tests/output_transonic/modes_cgns")
        print()
