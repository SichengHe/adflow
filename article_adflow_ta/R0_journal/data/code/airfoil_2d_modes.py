...
def test_transonic_modes():
    ...
    omega = 0.042  # See the sigma vs omega sweep plot. This is the highest sigma's omega.
    nModes = 3  # Three mode pairs for visualization. RK - Changed to 1 temporarily.
