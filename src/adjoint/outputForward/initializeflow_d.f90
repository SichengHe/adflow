...
!   variations   of useful results: *diagmatcoefspectral *dvector
...
! store the corresponding coefficient in dscalar.
            dscalard(ii, nn, ll) = coefspectrald(ii, mm)
...
! periodicity.
          ...
          do j=1,3
            do i=1,3
              dvectord(ii, kk+i, kk+j) = diagmatcoefspectrald(ii, i, j)
...
! directly in the matrix of time derivatives.
              do j=1,3
                do i=1,3
                  tmpmatd(i, j) = rotmatrixspectral(ii, 1, j)*&
&                   matrixcoefspectrald(ii, mm, i, 1) + &
&                   rotmatrixspectral(ii, 2, j)*matrixcoefspectrald(ii, &
&                   mm, i, 2) + rotmatrixspectral(ii, 3, j)*&
...
! into tmpmat.
              do j=1,3
                do i=1,3
                  tmpmatd(i, j) = matrixcoefspectrald(ii, mm, i, j)
...
! this submatrix in the correct place of dvector.
            ...
            do j=1,3
              do i=1,3
                dvectord(ii, kk+i, ll+j) = tmpmatd(i, j)
