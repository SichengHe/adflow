...
!   plus diff mem management of: sections:in
  subroutine timeperiodspectral_fast_b()
!
...
&           nn)%nslices
      ...
      if (branch .lt. 2) then
        if (branch .eq. 0) then
          tmpd = timeperiodd
          call commontimespectral_fast_b(timeperiod, tt, ttd, tmpd)
        else
          ttd = timeperiodd
        end if
  ...
  end subroutine timeperiodspectral_fast_b
...
!   with respect to varying inputs: t2
  subroutine commontimespectral_fast_b(t1, t2, t2d, commontimespectrald)
!
...
branch = myIntStack(myIntPtr)
 myIntPtr = myIntPtr - 1
  ...
  end subroutine commontimespectral_fast_b
...
end module partitioning_fast_b
