...
!   gradient     of useful results: *dvector *dscalar
...
!added to allow second call in mdupdateroutines
      ...
      call timespectralcoef_b(coefspectral, coefspectrald, &
...
!   plus diff mem management of: sections:in
  subroutine timespectralcoef_b(coefspectral, coefspectrald, &
...
&   :: coefspectrald
    real(kind=realtype), dimension(nsections, ntimeintervalsspectral - 1&
&   , 3, 3) :: matrixcoefspectral
    real(kind=realtype), dimension(nsections, ntimeintervalsspectral-1, &
&   3, 3) :: matrixcoefspectrald
